...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { move_type: @move.move_type, name: @move.name, url: @move.url } }, as: :json
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { move_type: @move.move_type, name: @move.name, url: @move.url } }, as: :json
    assert_response 200
  end
